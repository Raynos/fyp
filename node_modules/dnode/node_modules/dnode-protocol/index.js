...
var Session = exports.Session = function (id, wrapper) {
    ...
    //console.log("derp Session", self.localStore, self.remoteStore)
    ...
    self.parse = function (line) {
        ...
        try { self.handle(msg) }
            ...
            //console.log("LOLOLOLOL error", err, err.stack)
            self.emit('error', err) 
        }
    };
    ...
    self.handle = function (req) {
        ...
        if (req.method === 'methods') {
            ...
            if (self.instance.propertyIsEnumerable(req.method)) {
                //console.log("calling instance method", self.instance,
                //      req.method)
            ...
            //console.log("calling number", self.localStore.get(req.method),
            //  req.method, self.localStore)
    ...
    function apply(f, obj, args) {
        try { 
            //console.log("trying to apply", f, obj, args)
            f.apply(obj, args) 
        }
...
var Store = exports.Store = function() {
    ...
    //console.log("creating a fucking store", self, self.items)
    ...
    self.add = function (fn, id) {
        //console.log("adding fucking fn", fn, id, self)
